const TRANSLATIONS = {
    zh: {
        ...
        // Recovery & Purge
        badge_role_deleted: '角色已删除',
        btn_recovery: '恢复',
        btn_purge: '清除数据',
        recovery_title: '恢复被删角色',
        recovery_role_info: '角色信息（来自快照）',
        recovery_role_name: '角色名称',
        recovery_role_color: '角色颜色',
        recovery_deleted_at: '删除时间',
        recovery_affected_members: '受影响成员',
        recovery_affected_members_desc: '以下成员在快照中拥有该角色，恢复后将重新分配',
        recovery_no_members: '未找到受影响成员',
        recovery_action_desc: '执行恢复将：1) 在 Discord 中重建角色（如已不存在） 2) 为受影响成员批量生成同步任务 3) 重新启用映射',
        btn_execute_recovery: '执行恢复',
        recovery_success: '恢复已启动，同步任务已入队',
        recovery_error: '恢复失败',
        recovery_no_snapshot: '未找到角色快照，无法恢复',
        recovery_map_not_found: '映射不存在',
        purge_confirm_title: '确认清除数据',
        purge_warning: '此操作将永久删除该映射及相关同步日志，不可撤销！',
        purge_role_info: '即将清除的映射',
        purge_input_label: '请输入角色名称 "{0}" 以确认',
        purge_input_placeholder: '输入角色名称确认...',
        btn_confirm_purge: '确认永久清除',
        purge_success: '数据已清除',
        purge_error: '清除失败',
        purge_name_mismatch: '输入的角色名称不匹配',
        purge_source_label: '源角色',
        purge_target_label: '目标角色',
    },
    en: {
        // Nav
